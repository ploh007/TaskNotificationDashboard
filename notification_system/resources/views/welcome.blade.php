...
<div class="jumbotron" id="main-jumbotron">
    <div class="container">
        <div class="center-block custom-center">
            ...
            <!-- <div class="col-xs-6 col-md-3" style="margin: 0 auto;">
                <div class="thumbnail " style="background-color:#fff;border:none;">
                    <img src="./img/list.svg">
                </div>
            </div> -->
            <!-- <p>The task notification system works seamlessly with al your devices by simply making use of a web application. Receive notifications on the go wherever you are and stay on track.</p> -->
            </div>
            <div class="btn-group">
